...
func generateCRL(signer crypto.Signer, issuer *sm2.Certificate, thisUpdate, nextUpdate time.Time, number int64, revokedCertificates []pkix.RevokedCertificate) ([]byte, error) {
