...
func CreateResponse(issuer, responderCert *sm2.Certificate, template Response, priv crypto.Signer) ([]byte, error) {
	...
	//return nil, fmt.Errorf("[zzy-debug ocsp 257] test template.Status %q",template.Status)
	rawResponderID := asn1.RawValue{
	...
	//return nil, fmt.Errorf("[zzy-debug ocsp 280] test hashFunc %s",hashFunc)
	...
	//return nil, fmt.Errorf("[zzy-debug ocsp 305] test ")
