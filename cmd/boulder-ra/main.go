...
func main() {
	...
	var issuerCert *sm2.Certificate
	...
	IssuerCertPath:= s("/tmp/intermediate-cert-sm2-a.pem")
	issuerCert, err = core.LoadCert(*IssuerCertPath)
	cmd.FailOnError(err, "[zzy-debug boulder-ra main 171 :Failed to load issuer certificate")
