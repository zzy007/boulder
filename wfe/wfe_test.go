...
func TestIssueCertificate(t *testing.T) {
	...
	test.AssertUnmarshaledEquals(t,
		responseWriter.Body.String(),
		`{"type":"`+probs.V1ErrorNS+`malformed","detail":"Parse error reading JWS [zzy debug wfe\wfe_test:950]","status":400}`)
...
func TestNewRegistration(t *testing.T) {
	...
	regErrTests := []newRegErrorTest{
		...
		// POST, but body that isn't valid JWS
		{
			...
			`{"type":"` + probs.V1ErrorNS + `malformed","detail":"Parse error reading JWS [zzy debug wfe\wfe_test:1413]","status":400}`,
		},
...
func TestAuthorization(t *testing.T) {
	...
	test.AssertUnmarshaledEquals(t, responseWriter.Body.String(), `{"type":"`+probs.V1ErrorNS+`malformed","detail":"Parse error reading JWS[zzy debug wfe\wfe_test:1855]","status":400}`)
...
func TestRegistration(t *testing.T) {
	...
	test.AssertUnmarshaledEquals(t,
		responseWriter.Body.String(),
		`{"type":"`+probs.V1ErrorNS+`malformed","detail":"Parse error reading JWS[zzy debug wfe\wfe_test:2049]","status":400}`)
	responseWriter.Body.Reset()
...
func TestKeyRollover(t *testing.T) {
	...
	test.AssertUnmarshaledEquals(t,
		...
		`{
		  ...
		  "detail": "Parse error reading JWS[zzy debug wfe\wfe_test:2596]",
		  "status": 400
		}`)
