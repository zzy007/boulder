...
var goodSignatureAlgorithms = map[sm2.SignatureAlgorithm]bool{
	sm2.SHA1WithRSA:     true, // TODO(#2988): Remove support
	sm2.SHA256WithRSA:   true,
	sm2.SHA384WithRSA:   true,
	sm2.SHA512WithRSA:   true,
	sm2.ECDSAWithSHA256: true,
	sm2.ECDSAWithSHA384: true,
	sm2.ECDSAWithSHA512: true,
	sm2.SM2WithSM3:   true,
}
...
// if it is empty.
func VerifyCSR(ctx context.Context, csr *sm2.CertificateRequest, maxNames int, keyPolicy *goodkey.KeyPolicy, pa core.PolicyAuthority, regID int64) error {
	normalizeCSR(csr)
...
func normalizeCSR(csr *sm2.CertificateRequest) {
	if csr.Subject.CommonName == "" {
		var forcedCN string
