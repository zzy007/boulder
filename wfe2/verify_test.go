...
`
	fmt.Println("-----[zzy debug] server verify_test: TestParseJWSRequest() error -----")
	testCases := []struct {
		Name            string
		Request         *http.Request
		...
		},
		{
			...
			ExpectedProblem: &probs.ProblemDetails{
				Type:       probs.MalformedProblem,
				Detail:     "Parse error reading JWS  [zzy debug verify_test：835]",
				HTTPStatus: http.StatusBadRequest,
			},
...
func TestValidPOSTForAccount(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			ExpectedProblem: &probs.ProblemDetails{
				Type:       probs.MalformedProblem,
				Detail:     "Parse error reading JWS [zzy-debug verify_test:1291]",
				HTTPStatus: http.StatusBadRequest,
			},
			ErrorStatType: "JWSUnmarshalFailed",
		},
...
func TestValidSelfAuthenticatedPOST(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			ExpectedProblem: &probs.ProblemDetails{
				Type:       probs.MalformedProblem,
				Detail:     "Parse error reading JWS [zzy-debug verify_test:1469]",
				HTTPStatus: http.StatusBadRequest,
			},
			ErrorStatType: "JWSUnmarshalFailed",
		},
