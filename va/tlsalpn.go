...
// error message
func certNames(cert *sm2.Certificate) []string {
	var names []string
...
func (va *ValidationAuthorityImpl) tryGetTLSCerts(ctx context.Context,
	...
	tlsConfig *tls.Config) ([]*sm2.Certificate, *tls.ConnectionState, []core.ValidationRecord, *probs.ProblemDetails) {
...
func (va *ValidationAuthorityImpl) getTLSCerts(
	...
	config *tls.Config,
) ([]*sm2.Certificate, *tls.ConnectionState, *probs.ProblemDetails) {
