...
func (ssa *SQLStorageAuthority) GetRegistrationByKey(ctx context.Context, key *jose.JSONWebKey) (core.Registration, error) {
	...
	if err != nil {
		return core.Registration{}, fmt.Errorf("[zzy-debug]sa.go:KeyDigestB64 err %v",err)
	}
	...
	if err != nil {
		return core.Registration{},  fmt.Errorf("[zzy-debug]sa.go:selectRegistration err %v",err)
	}
...
func addIssuedNames(db db.Execer, cert *sm2.Certificate, isRenewal bool) error {
...
func addKeyHash(db db.Inserter, cert *sm2.Certificate) error {
