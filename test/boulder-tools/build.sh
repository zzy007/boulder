...
## Install GMSSL
#git clone https://github.com/guanzhi/GmSSL.git /etc/gmssl --depth 1
#cd /etc/gmssl
#./config
#make && make install
...
#
#
#git clone https://github.com/zzy007/ZzySoftHsmGM.git /tmp/softhsm2 --depth 1
#
#cd /tmp/softhsm2 && sh autogen.sh
#./configure --disable-gost --with-crypto-backend=openssl --with-openssl=/etc/gmssl
#make && make install
#
