...
type RegistrationAuthority interface {
	...
	// [WebFrontEnd]
	RevokeCertificateWithReg(ctx context.Context, cert sm2.Certificate, code revocation.Reason, regID int64) error
	...
	// [AdminRevoker]
	AdministrativelyRevokeCertificate(ctx context.Context, cert sm2.Certificate, code revocation.Reason, adminName string) error
}
